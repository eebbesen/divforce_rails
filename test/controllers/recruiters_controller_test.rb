...
class RecruitersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recruiter" do
    assert_difference('Recruiter.count') do
      post recruiters_url, params: { recruiter: { certified: @recruiter.certified, name: @recruiter.name, notes: @recruiter.notes } }
    end
  ...
  test "should update recruiter" do
    patch recruiter_url(@recruiter), params: { recruiter: { certified: @recruiter.certified, name: @recruiter.name, notes: @recruiter.notes } }
