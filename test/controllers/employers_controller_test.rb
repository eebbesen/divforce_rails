...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post employers_url, params: { employer: { certified: @employer.certified, industry: @employer.industry, name: @employer.name, notes: @employer.notes } }
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { certified: @employer.certified, industry: @employer.industry, name: @employer.name, notes: @employer.notes } }
